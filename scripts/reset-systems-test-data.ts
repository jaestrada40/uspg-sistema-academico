...
await prisma.$transaction(async (tx) => {
  ...
  await tx.curriculumPlan.create({ data: { id: 'PLAN-SIS2026B-CC', code: 'SIS2026B-CC', name: 'Ingeniería en Sistemas y Ciencias de la Computación', version: '2026B', effectiveFrom: new Date('2026-07-01'), status: 'Activo', totalCredits: 200, durationSemesters: 8, careerId: 'CAR-SIS' } });
