...
export const UsersPage: React.FC = () => {
  ...
  const resetPassword = async (user: ManagedUser) => {
    if (!window.confirm(`Se cerrarán las sesiones de ${user.name} y se generará una contraseña temporal. ¿Continuar?`)) return;
