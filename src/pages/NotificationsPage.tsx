...
export const NotificationsPage: React.FC = () => {
  ...
  const firstRecord = records.length ? (currentPage - 1) * pageSize + 1 : 0;
  const lastRecord = Math.min(currentPage * pageSize, records.length);

  return <RoleGuard allowedRoles={['ADMIN']}><div className="space-y-6"><PageHeader title="Notificaciones Institucionales" description="Avisos dentro de la plataforma y seguimiento de correos institucionales" breadcrumbs={[{ label: 'Inicio', href: '/dashboard' }, { label: 'Notificaciones', active: true }]} />
