...
export const NotificationsPage: React.FC = () => {
  ...
  const loadOutbox = useCallback(async () => {
    ...
    const result = await response.json(); setRecords(result.records); setSmtpConfigured(result.smtpConfigured);
  }, []);
