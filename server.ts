...
const emailHtml = (title: string, message: string, link?: string, hasLogo = false) => {
  ...
  const logo = hasLogo ? '<img src="cid:uspg-logo" alt="Universidad de San Pablo" width="260" style="display:block;width:260px;max-width:100%;height:auto;margin:0 0 16px;border:0">' : '';
